...
var prefix = ayarlar.prefix;
  ...
  if (!message.member.roles.cache.some(role => role.name === "Ban Çekici")) return message.channel.send(`Bu komutu kullanabilmek için **Üyeleri Yasakla** iznine sahip olmalısın!`);
