...
var prefix = ayarlar.prefix;             
  ...
  if (!message.member.roles.cache.some(role => role.name === "Kick Çekici")) return message.channel.send(`Bu komutu kullanabilmek için **Üyeleri At** iznine sahip olmalısın!`);
